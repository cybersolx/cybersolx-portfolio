...
const PrivacyPolicy = () => {
  return (
    <div>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Cybersolx, HOUSE #9, STREET #2, ABBASIA
            COLONY, THANDACHOWA, ILYASI ROAD, NAWANSHAHR, ABBOTTABAD.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Cybersolx, accessible from{' '}
            <a
              href="https://Cybersolx.com/"
      ...
      <ul>
        <li>
          <p>By email: info@Cybersolx.com</p>
        </li>
        <li>
          <p>
            By visiting this page on our website:{' '}
            <a
              href="https://Cybersolx.com/contact"
              rel="external nofollow noopener noreferrer"
              target="_blank"
            >
              https://Cybersolx.com/contact
            </a>
          </p>
        </li>
      </ul>
