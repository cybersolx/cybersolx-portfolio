            ...
            <div className="slide-content-box container">
              <div className="max-w600 text-white">
                <h2 className="text-white font-weight-400">
                  We would turn great ideas into
                ...
                <p>
                  ...
                  the true value we provide. We help you in all the stages of
                  realization of your digital products.
                </p>
            ...
            <div className="slide-content-box container">
              <div className="max-w600 text-white">
                <h2 className="text-white font-weight-400">
                  ...
                  <br /> and be proud, whatever you do.{' '}
                </h2>
                <p>
